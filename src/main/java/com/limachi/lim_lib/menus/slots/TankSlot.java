...
public class TankSlot extends Slot implements IFluidHandler {
    ...
    public static class FluidRenderer {
        ...
        public static final ResourceLocation FLUID_SLOT = new ResourceLocation(LimLib.COMMON_ID, "textures/screen/slots/fluid_slot.png");
        public static final ResourceLocation FLUID_SLOT_OVERLAY = new ResourceLocation(LimLib.COMMON_ID, "textures/screen/slots/fluid_slot_overlay.png");
