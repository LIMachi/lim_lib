...
public class Sides {
    ...
    public static List<? extends Player> getPlayers() { return DistExecutor.unsafeRunForDist(()->()->isLogicalClient() ? Collections.singletonList(Minecraft.getInstance().player) : getServer().getPlayerList().getPlayers(), ()->()->getServer().getPlayerList().getPlayers()); }
