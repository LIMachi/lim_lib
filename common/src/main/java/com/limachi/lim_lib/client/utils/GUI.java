...
import com.limachi.lim_lib.common.math.Pos2d;
import com.limachi.lim_lib.common.math.Rect2d;
import com.limachi.lim_lib.common.math.Size2d;
...
public class GUI {
    ...
    public static final ResourceLocation BACKGROUND_TEXTURE = ResourceLocation.fromNamespaceAndPath("lim_lib", "textures/screen/background.png");
    ...
    public static void setColor(GuiGraphics gui, int color) {
        gui.setColor((float) ((color & 0xFF0000) >> 16) / 255f, (float) ((color & 0xFF00) >> 8) / 255f, (float) (color & 0xFF) / 255f, (float) ((color & 0xFF000000) >> 24) / 255f);
    }

    public static void emptySquare(GuiGraphics gui, Rect2d rect, int color) {
        gui.hLine((int)rect.x0(), (int)rect.x1(), (int)rect.y0(), color);
        gui.hLine((int)rect.x0(), (int)rect.x1(), (int)rect.y1(), color);
        gui.vLine((int)rect.x0(), (int)rect.y0(), (int)rect.y1(), color);
        gui.vLine((int)rect.x1(), (int)rect.y0(), (int)rect.y1(), color);
    }
}
