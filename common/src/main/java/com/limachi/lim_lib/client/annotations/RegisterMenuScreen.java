...
public @interface RegisterMenuScreen {
    String value() default ""; //registry name of the menu associated with this screen (if not set, will be matched against the snake case representation of the annotated class)
