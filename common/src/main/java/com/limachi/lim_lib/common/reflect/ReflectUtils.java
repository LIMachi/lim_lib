...
import static com.limachi.lim_lib.common.utils.StringUtils.subString;
...
public class ReflectUtils {
    ...
    public static List<Class<?>> loadedClasses() {
        ...
        try {
            Field field = loader.getClass().getField("classes");
            field.setAccessible(true);
            return Collections.unmodifiableList((ArrayList<Class<?>>)field.get(loader));
