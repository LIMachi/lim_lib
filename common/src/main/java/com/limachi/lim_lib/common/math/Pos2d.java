package com.limachi.lim_lib.common.math;
...
public record Pos2d(double x, double y) implements Constable {
    ...
    public static Pos2d from(ScreenRectangle screenRect) { return new Pos2d(screenRect.left(), screenRect.top()); }
    @Environment(EnvType.CLIENT)
    public static Pos2d from(ScreenPosition screenPos) { return new Pos2d(screenPos.x(), screenPos.y()); }
    @Environment(EnvType.CLIENT)
    public ScreenPosition screenPosition() { return new ScreenPosition((int)x, (int)y); }
